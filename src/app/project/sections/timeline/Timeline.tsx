...
const events = [
  ...
  { date: "Before Build Start", title: "Draft of Designs (specs & sim)", description: "Due before you start to build", current: true },
  ...
  { date: "March 10, 2025", title: "Preliminary Design Report (PDR)", description: "PDR along with Model Rocket Flights documentation" },
